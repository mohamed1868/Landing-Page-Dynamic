        ...
        <div className="SectionSeven" data-aos="fade-down" id="SectionSeven">
            ...
            <Row style={{ gap: "25px", justifyContent: "center", marginTop: "40px" }}>
                <Col xs={16} md={11} xl={7} className="SectionSevenContaier">
                    <div style={{ fontWeight: "bold" ,fontSize: "16px" , textAlign:"center"}}>  {t("sectionSevenPage2Title")} </div>
                    <div style={{ opacity: "0.7", marginTop: "10px", fontSize: "14px" , textAlign:"center"}}> {t("sectionSevenPage2P")}       </div>
                    <div>
